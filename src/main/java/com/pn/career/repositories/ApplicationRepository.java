...
public interface ApplicationRepository extends JpaRepository<Application, Integer> {
    ...
    List<Application> findAllByJob_JobIdAndApplicationStatus(Integer jobId, ApplicationStatus status);
    @Query("SELECT a FROM Application a WHERE a.resume.student.userId = :studentId ORDER BY a.createdAt DESC")
    List<Application> findAppliedApplicationsByStudentIdOrderedByDate(
