...
public class VNPAYService {
    public String createPaymentUrl(HttpServletRequest request, Order order, String returnUrl) {
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(order.getTotal().multiply(new BigDecimal("100")).longValue()));
